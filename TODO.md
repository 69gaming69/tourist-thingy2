...
- [x] 4. Edit `app/components/navbar.tsx` — Logo badge & link hovers
- [x] 5. Edit `app/page.tsx` — Backgrounds, accent dot, surface tones
- [x] 6. Edit `app/components/GeoapifyMap.tsx` — Search icon, focus ring, pills, marker
